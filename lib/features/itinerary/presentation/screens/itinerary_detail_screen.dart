...
class _ItineraryDetailScreenState extends State<ItineraryDetailScreen>
  ...
  static const _daySchedules = [
    [
      ...
      (name: 'Bữa trưa - Bún mắm', emoji: '🍜', timeStart: '12:30', durationMin: 60),
    ...
    [
      (name: 'Bán đảo Sơn Trà', emoji: '🌿', timeStart: '07:00', durationMin: 180),
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: CachedNetworkImage(
                imageUrl: widget.imageUrl ?? 'https://picsum.photos/seed/itin1/400/220',
                fit: BoxFit.cover,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: AppSpacing.space1),
                      Text('1.2K lượt xem', style: AppTextStyles.caption.copyWith(color: AppColors.textSecondary)),
                    ],
                  ),
                ],
              ),
            ...
            Expanded(
              child: TabBarView(
                ...
                children: [
                  ...
                  const Center(child: Icon(Icons.map_rounded, size: 64, color: SagePalette.sage300)),
                  // Tab 2: Details
      ...
      bottomNavigationBar: SafeArea(
        child: Padding(
          ...
          child: widget.isOwner
              ...
              : AppButton(label: '📋 Sao chép lịch trình này', onPressed: () {}),
        ),
      ),
    );
  }
...
class _TimelineTab extends StatelessWidget {
  ...
  final int numDays;
  final List<List<({String name, String emoji, String timeStart, int durationMin})>> daySchedules;
  final int selectedDay;
  final ValueChanged<int> onDaySelected;

  @override
  Widget build(BuildContext context) {
    final current = selectedDay < daySchedules.length ? daySchedules[selectedDay] : [];
...
class _DetailsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Mô tả', style: AppTextStyles.h4.copyWith(fontWeight: FontWeight.w600)),
            const SizedBox(height: AppSpacing.space2),
            Text(
            ...
            Text('Ngân sách ước tính', style: AppTextStyles.h4.copyWith(fontWeight: FontWeight.w600)),
            const SizedBox(height: AppSpacing.space2),
...
class _BudgetRow extends StatelessWidget {
  const _BudgetRow({required this.label, required this.amount, this.isBold = false});
  final String label;
  final int amount;
  final bool isBold;
  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Row(
          ...
          children: [
            Text(label, style: AppTextStyles.bodyMd.copyWith(fontWeight: isBold ? FontWeight.w700 : FontWeight.w400, color: AppColors.textPrimary)),
            Text(
