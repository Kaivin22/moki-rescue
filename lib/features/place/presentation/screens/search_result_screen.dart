...
class _SearchResultScreenState extends State<SearchResultScreen> {
  ...
  static const _demoResults = [
    (name: 'Bãi biển Mỹ Khê', category: 'beach', rating: 4.7, imageUrl: 'https://picsum.photos/seed/mykhe/160/160', distance: 2.1, isSaved: false, address: 'Quận Sơn Trà, Đà Nẵng'),
    (name: 'Bãi biển Nam Ô', category: 'beach', rating: 4.3, imageUrl: 'https://picsum.photos/seed/namO/160/160', distance: 12.0, isSaved: true, address: 'Liên Chiểu, Đà Nẵng'),
    (name: 'Bãi biển Lăng Cô', category: 'beach', rating: 4.5, imageUrl: 'https://picsum.photos/seed/langco/160/160', distance: 55.0, isSaved: false, address: 'Phú Lộc, Thừa Thiên Huế'),
  ];
