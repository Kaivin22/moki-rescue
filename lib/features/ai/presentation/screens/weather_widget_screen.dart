...
class _WeatherWidgetScreenState extends ConsumerState<WeatherWidgetScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return weatherAsync.when(
      ...
      error: (e, _) =>
          Scaffold(body: Center(child: Text('Lỗi tải thời tiết: $e'))),
      data: (weather) {
